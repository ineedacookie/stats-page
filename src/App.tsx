...
import { LiveCamStage } from './components/LiveCamStage'
...
function App() {
  ...
  return (
    <main className="h-screen w-screen overflow-hidden bg-black text-slate-100">
      {scene === 'cam' ? (
        <div key="cam" className="scene-fade-in h-full w-full">
          <LiveCamStage
            cam={cam}
        ...
        <div key="stats" className="scene-fade-in h-full w-full bg-slate-950">
          {isLoading && !data ? (
